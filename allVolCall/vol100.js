...
document.addEventListener('DOMContentLoaded', function () {
    ...
    symbol100 = localStorage.getItem('symbol100')
    symbol100_cookie = getCookie('symbol100')
...
let currentvol_carousel5_cookie = null
let currentvol2_carousel5_cookie = null
let martingale_active_carousel5_cookie = null
let bot_set_carousel5_cookie = null
let set_bot_jump_carousel5_cookie = null
...
const tickResponse = async (res) => {
    ...
    if (data.msg_type === 'tick') {
        ...
        currentvol_carousel5_cookie = getCookie('bot_current_vol1_carousel5');
        currentvol2_carousel5_cookie = getCookie('bot_current_vol2_carousel5');
        martingale_active_carousel5_cookie = getCookie('martingale_carousel5');
        bot_set_carousel5_cookie = getCookie('bot_set_carousel5');
        set_bot_jump_carousel5_cookie = getCookie('bot_jump_carousel5')
        
        if(((set_bot_jump_carousel5 && set_bot_jump_carousel5 > 0) && contract_status2 == 'lost') || ((set_bot_jump_carousel5_cookie && set_bot_jump_carousel5_cookie > 0) && contract_status2 == 'lost')){
            bot_set_carousel5 = (parseInt(bot_set_carousel5) + parseInt(set_bot_jump_carousel5)) !== null ? (parseInt(bot_set_carousel5) + parseInt(set_bot_jump_carousel5)) : (parseInt(bot_set_carousel5_cookie) + parseInt(set_bot_jump_carousel5_cookie))
            contract_status2 == 'reset'
        }else if((initial_set_jump == true || (contract_status2 == 'won' && (set_bot_jump_carousel5 && set_bot_jump_carousel5 > 0))) || (initial_set_jump_cookie == true || (contract_status2 == 'won' && (set_bot_jump_carousel5_cookie && set_bot_jump_carousel5_cookie > 0)))){
            bot_set_carousel5 = localStorage.getItem('bot_set_carousel5') ? localStorage.getItem('bot_set_carousel5') : getCookie('bot_set_carousel5');
...
let currentIndex = parseInt(localStorage.getItem('bot_current_vol1_carousel5')) || 0;
let currentIndex2 = parseInt(localStorage.getItem('bot_current_vol2_carousel5')) || 0;
let currentIndex3 = parseInt(localStorage.getItem('bot_current_vol3_carousel5')) || 0;

let currentIndex_cookie = parseInt(getCookie('bot_current_vol1_carousel5')) || 0;
let currentIndex2_cookie = parseInt(getCookie('bot_current_vol2_carousel5')) || 0;
let currentIndex3_cookie = parseInt(getCookie('bot_current_vol3_carousel5')) || 0;
...
prevButton.addEventListener("click", function () {
    if (currentIndex !== null && currentIndex >= 0) {
        ...
        localStorage.setItem('bot_current_vol2_carousel5', currentIndex2);
        setCookie('bot_current_vol2_carousel5', currentIndex2);
        volumes[currentIndex].classList.add("active");
        volumes2[currentIndex].classList.add("active");
        ...
        localStorage.setItem('bot_current_vol1_carousel5', currentIndex_cookie);
        localStorage.setItem('bot_current_vol3_carousel5', currentIndex_cookie);
        setCookie('bot_current_vol1_carousel5', currentIndex_cookie);
        setCookie('bot_current_vol3_carousel5', currentIndex_cookie);
        currentIndex2_cookie = (currentIndex2_cookie - 1 + volumes_stream.length) % volumes_stream.length;
        localStorage.setItem('bot_current_vol2_carousel5', currentIndex2_cookie);
        setCookie('bot_current_vol2_carousel5', currentIndex2_cookie);
        volumes[currentIndex_cookie].classList.add("active");
        volumes2[currentIndex_cookie].classList.add("active");
...
prevButton2.addEventListener("click", function () {
    if (currentIndex !== null && currentIndex >= 0) {
        ...
        setCookie('bot_current_vol3_carousel5', currentIndex_cookie)
        currentIndex2_cookie = (currentIndex2_cookie - 1 + volumes_stream.length) % volumes_stream.length;
        localStorage.setItem('bot_current_vol2_carousel5', currentIndex_cookie)
        setCookie('bot_current_vol2_carousel5', currentIndex_cookie)
        volumes[currentIndex_cookie].classList.add("active");
        volumes2[currentIndex_cookie].classList.add("active");
        volumes_stream[currentIndex2_cookie].classList.add("active");
    }
