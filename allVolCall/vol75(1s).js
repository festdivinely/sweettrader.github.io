...
let close_contract_result_container = document.getElementById('close_contract_result_container_carousel9')
let buy_sell_two = document.getElementById('buy_sell_two')


let trade_type_secound = document.getElementById("trade_type_secound")

let attempting_buy2_carousel9 = document.getElementById("attempting_buy2_carousel9")//change to 25
let buy_succeded2_carousel9 = document.getElementById("buy_succeded2_carousel9")//change to 25
let contract_close2_carousel9 = document.getElementById("contract_close2_carousel9")//change to 25

let stream75_1s_carousel9 = document.getElementById('stream75_1s_carousel9')//change to 25
...
let td2_account_id_carousel9 = document.getElementById('td2_account_id_carousel9') // change to 25
let td2_no_of_runs_carousel9 = document.getElementById('td2_no_of_runs_carousel9') // change to 25
let td2_total_stake_carousel9 = document.getElementById('td2_total_stake_carousel9') // change to 25
let td2_total_payout_carousel9 = document.getElementById('td2_total_payout_carousel9') // change to 25
let td2_total_wins_carousel9 = document.getElementById('td2_total_wins_carousel9') // change to 25
let td2_total_loss_carousel9 = document.getElementById('td2_total_loss_carousel9') // change to 25
let td2_total_profit_loss_carousel9 = document.getElementById('td2_total_profit_loss_carousel9') // change to 25
...
let symbol75_1s = null
let symbol75_1s_cookie = null
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    symbol75_1s = localStorage.getItem('symbol75_1s')
    symbol75_1s_cookie = setCookie('symbol75_1s')
...
async function add_after_trade(bot_id, botuniqueCode, allContracts, entry_spot, exit_spot, profit_loss, status, bot_total_runs, bot_total_stake, bot_total_payout, bot_total_wins, bot_total_loss, bot_total_profit_loss) {
    const tbody1_carousel9 = document.getElementById('tbody1_carousel9'); // change to 25


    if (botuniqueCode == allContracts) {

        console.log('yes', botuniqueCode, allContracts)
        let row_carousel9 = document.getElementById(`bot_carousel9${bot_id}`); // change to 25
        ...
        const entry_spot_html_carousel9 = document.getElementById(`td5_carousel9${bot_id}`); // change to 25
        const exit_spot_html_carousel9 = document.getElementById(`td6_carousel9${bot_id}`); // change to 25
        const profit_loss_html_carousel9 = document.getElementById(`td8_carousel9${bot_id}`); // change to 25
        const status_html_carousel9 = document.getElementById(`td9_carousel9${bot_id}`); // change to 25
        ...
        td2_no_of_runs_carousel9.textContent = bot_total_runs
        td2_total_stake_carousel9.textContent = bot_total_stake
        td2_total_payout_carousel9.textContent = Number(bot_total_payout.toFixed(2));
        td2_total_wins_carousel9.textContent = bot_total_wins
        td2_total_wins_carousel9.style.color = 'green'
        td2_total_loss_carousel9.textContent = bot_total_loss
        td2_total_loss_carousel9.style.color = 'red'
        td2_total_profit_loss_carousel9.textContent = Number(bot_total_profit_loss.toFixed(2));
        if (parseFloat(Number(bot_total_profit_loss.toFixed(2))) < 0) {
            td2_total_profit_loss_carousel9.style.color = 'red'
        } else {
            td2_total_profit_loss_carousel9.style.color = 'green'
        }
    }
...
const progressBar1_carousel9 = document.querySelector('.progress1_carousel9'); //change to 25

function fillProgressBar1() {
    progressBar1_carousel9.classList.add('prog1_carousel9') //change to 25
}

const progressBar2_carousel9 = document.querySelector('.progress2_carousel9'); //change to 25

function fillProgressBar2() {
    progressBar2_carousel9.classList.add('prog2_carousel9') //change to 25
}
...
function set_start_trade1(bot_is_running_or_stopped) {
    ...
    if (progressBar1_carousel9.classList.contains("prog1_carousel9")) {
        progressBar1_carousel9.classList.remove('prog1_carousel9')
    }

    if (progressBar2_carousel9.classList.contains("prog2_carousel9")) {
        progressBar2_carousel9.classList.remove('prog2_carousel9')
    }
...
function start_trade_ref(buy_price_ref) {
    if (attempting_buy2_carousel9.classList.contains("attempting_buy2_show_carousel9")) {
        attempting_buy2_carousel9.classList.remove("attempting_buy2_show_carousel9")
    }
    if (buy_succeded2_carousel9.classList.contains("buy_succeded2_show_carousel9")) {
        buy_succeded2_carousel9.classList.remove("buy_succeded2_show_carousel9")
    }
    if (contract_close2_carousel9.classList.contains("contract_close2_show_carousel9")) {
        contract_close2_carousel9.classList.remove("contract_close2_show_carousel9")
    }
    attempting_buy2_carousel9.textContent = `Buy amount: ${buy_price_ref}`
    attempting_buy2_carousel9.classList.add('attempting_buy2_show_carousel9')
}
...
function middle_trade_ref(buy_ref) {
    buy_succeded2_carousel9.textContent = `ID: ${buy_ref}`
    buy_succeded2_carousel9.classList.add('buy_succeded2_show_carousel9')
}
...
function end_trade_ref(sell_ref) {
    contract_close2_carousel9.textContent = `ID: ${sell_ref}`
    contract_close2_carousel9.classList.add('contract_close2_show_carousel9')
}
...
async function buy_bot(martingale, current_number) {
    ...
    try {
        ...
        await order_propose(api, stake_amount, last_digit_prediction_or_barrier, stake_or_payout, contract, currency, duration_amount, duration_unit, symbol75_1s);
    ...
    function appendRows(data) {
        data.forEach(item => {
            ...
            if (tbody_carousel9.firstChild) {
                ...
                tbody_carousel9.appendChild(row_carousel9); // If tbody is empty, just append
            }
        });
    }
...
async function bot_log(last_ten_tick, last_nine_tick, last_eight_tick, last_seven_tick, last_six_tick, last_five_tick, last_four_tick, last_three_tick, last_two_tick, last_one_tick, current_tick, current_tick_full) {
    ...
    function appendRows(data) {
        data.forEach(item => {
            // Create <tr> element
            const row_carousel9 = document.createElement('tr');
            row_carousel9.id = `log_bot_carousel9${log_id}`;

            const td1_carousel9 = document.createElement('td');
            td1_carousel9.textContent = log_timestamp_current;
            td1_carousel9.id = `log_td1_carousel9${log_id}`;
            ...
            td2_carousel9.textContent = `last ten ticks:  ${item.log_message10} ${item.log_message9} ${item.log_message8} ${item.log_message7} ${item.log_message6} ${item.log_message5} ${item.log_message4} ${item.log_message3} ${item.log_message2} ${item.log_message1}          current tick ${item.log_message_curr}    ${item.log_message_curr_tick}`;

            td2_carousel9.style.whiteSpace = 'pre'
            td2_carousel9.id = `log_td2_carousel9${log_id}`;
            ...
            td3_carousel9.id = `log_td3_carousel9${log_id}`;
            ...
            if (log_tbody_carousel9.firstChild) {
                ...
                log_tbody_carousel9.appendChild(row_carousel9); // If tbody is empty, just append
                appended = true
            }
        });
    }
...
async function bot_log_end(bot_buy_time_stamp, bot_sell_time_stamp, newValueForEntryTick, newValueForLastDigit) {
    let target_td_carousel9 = document.getElementById(`log_td3_carousel9${log_id}`)
    ...
    if (target_td_carousel9) {
        target_td_carousel9.textContent = `buy_time:  ${log_buy_timestamp_bot}        sell_time:  ${log_sell_timestamp_bot}    entry tick:  ${newValueForEntryTick}     last digit:  ${newValueForLastDigit}`
...
let bot_state_carousel9 = "stop_bot"
let all_bot_start_stop1 = null
let all_bot_start_stop1_cookie = null

let buttonContainer_carousel9 = document.querySelector('.click_change_carousel9');
...
function togglePlayPause() {
    ...
    if (play_button_carousel9) {
        ...
        buttonContainer_carousel9.appendChild(play_button_carousel9);
        document.getElementById('bot_state_carousel9').textContent = 'Bot is running';
    }
}
// Add click event listener to button container
buttonContainer_carousel9.addEventListener('click', togglePlayPause);
...
let currentvol_carousel9 = null
let currentvol2_carousel9 = null
let martingale_active_carousel9 = null
let bot_set_carousel9 = null
let set_bot_jump_carousel9 = null
let initial_set_jump = true

let currentvol_carousel9_cookie = null
let currentvol2_carousel9_cookie = null
let martingale_active_carousel9_cookie = null
let bot_set_carousel9_cookie = null
let set_bot_jump_carousel9_cookie = null
...
const tickStream = () => api.subscribe({ "ticks": '1HZ75V' });
...
const tickResponse = async (res) => {
    ...
    if (data.msg_type === 'tick') {
        let bot_start_stop = bot_state_carousel9
        ...
        stream75_1s_carousel9.textContent = strNumber

        all_bot_start_stop1 = localStorage.getItem('all_bot_start_stop1')
        all_bot_start_stop1_cookie = getCookie('all_bot_start_stop1')

        currentvol_carousel9 = localStorage.getItem('bot_current_vol1_carousel9');
        currentvol2_carousel9 = localStorage.getItem('bot_current_vol2_carousel9');
        martingale_active_carousel9 = localStorage.getItem('martingale_carousel9');
        bot_set_carousel9 = localStorage.getItem('bot_set_carousel9');
        set_bot_jump_carousel9 = localStorage.getItem('bot_jump_carousel9')

        currentvol_carousel9_cookie = getCookie('bot_current_vol1_carousel9');
        currentvol2_carousel9_cookie = getCookie('bot_current_vol2_carousel9');
        martingale_active_carousel9_cookie = getCookie('martingale_carousel9');
        bot_set_carousel9_cookie = getCookie('bot_set_carousel9');
        set_bot_jump_carousel9_cookie = getCookie('bot_jump_carousel9')

        if (((set_bot_jump_carousel9 && set_bot_jump_carousel9 > 0) && contract_status2 == 'lost') || ((set_bot_jump_carousel9_cookie && set_bot_jump_carousel9_cookie > 0) && contract_status2 == 'lost')) {
            bot_set_carousel9 = (parseInt(bot_set_carousel9) + parseInt(set_bot_jump_carousel9)) !== null ? (parseInt(bot_set_carousel9) + parseInt(set_bot_jump_carousel9)) : (parseInt(bot_set_carousel9_cookie) + parseInt(set_bot_jump_carousel9_cookie))
            contract_status2 == 'reset'
        } else if ((initial_set_jump == true || (contract_status2 == 'won' && (set_bot_jump_carousel9 && set_bot_jump_carousel9 > 0))) || (initial_set_jump_cookie == true || (contract_status2 == 'won' && (set_bot_jump_carousel9_cookie && set_bot_jump_carousel9_cookie > 0)))) {
            bot_set_carousel9 = localStorage.getItem('bot_set_carousel9') ? localStorage.getItem('bot_set_carousel9') : getCookie('bot_set_carousel9');
        ...
        if (currentRandom !== null && lastNumber1 !== null && lastNumber2 !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance == true) {
                if (currentRandom && (first_instance == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9 == 1)) {
                    if (bot_start_stop == 'start_bot' || all_bot_start_stop1 == 'start_bots' && ((currentvol_carousel9 == 8 && currentvol2_carousel9 == 8))) {
                        startBot(martingale_active_carousel9, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber)
        ...
        if (currentRandom !== null && lastNumber1 !== null && lastNumber2 !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance == true) {
                if (lastNumber1 == currentRandom && (first_instance == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9 == 2)) {
                    if (bot_start_stop == 'start_bot' || all_bot_start_stop1 == 'start_bots' && ((currentvol_carousel9 == 8 && currentvol2_carousel9 == 8))) {
                        startBot(martingale_active_carousel9, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber)
                    } else if (bot_start_stop == 'stop_bot') {
                        console.log('bot has stopped running')
        ...
        if (currentRandom !== null && lastNumber1 !== null && lastNumber2 !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance == true) {
                if (lastNumber2 == currentRandom && lastNumber1 == currentRandom && (first_instance == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9 == 3)) {
                    if (bot_start_stop == 'start_bot' || all_bot_start_stop1 == 'start_bots' && ((currentvol_carousel9 == 8 && currentvol2_carousel9 == 8))) {
                        startBot(martingale_active_carousel9, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber)
                    } else if (bot_start_stop == 'stop_bot') {
                        console.log('bot has stopped running')
        ...
        if (currentRandom !== null && lastNumber1 !== null && lastNumber2 !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance == true) {
                if (lastNumber3 == currentRandom && lastNumber2 == currentRandom && lastNumber1 == currentRandom && (first_instance == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9 == 4)) {
                    if (bot_start_stop == 'start_bot' || all_bot_start_stop1 == 'start_bots' && ((currentvol_carousel9 == 8 && currentvol2_carousel9 == 8))) {
                        startBot(martingale_active_carousel9, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber)
                    } else if (bot_start_stop == 'stop_bot') {
                        console.log('bot has stopped running')
        ...
        if (currentRandom !== null && lastNumber1 !== null && lastNumber2 !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance == true) {
                if (lastNumber4 == currentRandom && lastNumber3 == currentRandom && lastNumber2 == currentRandom && lastNumber1 == currentRandom && (first_instance == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9 == 5)) {
                    if (bot_start_stop == 'start_bot' || all_bot_start_stop1 == 'start_bots' && ((currentvol_carousel9 == 8 && currentvol2_carousel9 == 8))) {
                        startBot(martingale_active_carousel9, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber)
                    } else if (bot_start_stop == 'stop_bot') {
                        console.log('bot has stopped running')
        ...
        if (currentRandom !== null && lastNumber1 !== null && lastNumber2 !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance == true) {
                if (lastNumber5 == currentRandom && lastNumber4 == currentRandom && lastNumber3 == currentRandom && lastNumber2 == currentRandom && lastNumber1 == currentRandom && (first_instance == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9 == 6)) {
                    if (bot_start_stop == 'start_bot' || all_bot_start_stop1 == 'start_bots' && ((currentvol_carousel9 == 8 && currentvol2_carousel9 == 8))) {
                        startBot(martingale_active_carousel9, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber)
                    } else if (bot_start_stop == 'stop_bot') {
                        console.log('bot has stopped running')
        ...
        if (currentRandom !== null && lastNumber1 !== null && lastNumber2 !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance == true) {
                if (lastNumber6 == currentRandom && lastNumber5 == currentRandom && lastNumber4 == currentRandom && lastNumber3 == currentRandom && lastNumber2 == currentRandom && lastNumber1 == currentRandom && (first_instance == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9 == 7)) {
                    if (bot_start_stop == 'start_bot' || all_bot_start_stop1 == 'start_bots' && ((currentvol_carousel9 == 5 && currentvol2_carousel9 == 5) || (currentvol_carousel9 == 0 && currentvol2_carousel9 == 0))) {
                        startBot(martingale_active_carousel9, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber)
                    } else if (bot_start_stop == 'stop_bot') {
                        console.log('bot has stopped running')
                    } else {
        ...
        if (currentRandom !== null && lastNumber1 !== null && lastNumber2 !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance == true) {
                if (lastNumber7 == currentRandom && lastNumber6 == currentRandom && lastNumber5 == currentRandom && lastNumber4 == currentRandom && lastNumber3 == currentRandom && lastNumber2 == currentRandom && lastNumber1 == currentRandom && (first_instance == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9 == 8)) {
                    if (bot_start_stop == 'start_bot' || all_bot_start_stop1 == 'start_bots' && ((currentvol_carousel9 == 8 && currentvol2_carousel9 == 8))) {
                        startBot(martingale_active_carousel9, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber)
                    } else if (bot_start_stop == 'stop_bot') {
                        console.log('bot has stopped running')
...
async function initializeApi(message1) {
    ...
    try {
        ...
        if (!authorize_response.authorize) {
            ...
            console.log("authirzed at vol75_1s js")

            if (authorize_response.authorize.loginid.startsWith("CR")) {

                td2_account_id_carousel9.textContent = authorize_response.authorize.loginid
...
//change to 25
let contract_status_html = document.getElementById('contract_status_carousel9') //change to 25 
let end_tic_off_trade = document.getElementById('end_tic_off_trade_carousel9') //change to 25            
let price_after_trade_figure_amount = document.getElementById('price_after_trade_figure_amount_carousel9') //change to 25
let profit_figure_amount = document.getElementById('profit_figure_amount_carousel9') //change to 25
let buy_price_figure_amount = document.getElementById('buy_price_figure_amount_carousel9') //change to 25
let result_currency_html = document.querySelectorAll('.result_currency')
let transaction_refrence_figure = document.getElementById('transaction_refrence_figure_carousel9') //change to 25
let trade_start_time = document.getElementById('trade_start_time_carousel9') //change to 25
let buy_price_text = document.getElementById('buy_price_text_carousel9') //change to 25
let price_after_trade_text = document.getElementById('price_after_trade_text_carousel9') //change to 25
let profit_text = document.getElementById('profit_text_carousel9') //change to 25
...
function open_proposal_actions(data) {
    if (data.proposal_open_contract.contract_id == contract_id) {
        ...
        document.getElementById('proposal_information_carousel9').textContent = longcodeProp
...
function open_proposal_actions2(data) {
    if (data.proposal_open_contract.contract_id == contract_id2) {
        ...
        document.getElementById('proposal_information_carousel9').textContent = longcodeProp2
...
const elements = document.querySelectorAll('.lgt9');
...
// let close_summary_carousel9 = document.getElementById('close_summary_carousel9')
...
//     close_summary_carousel9.addEventListener('click', (event) => {
...
let log_close_and_info_cont = document.getElementById('log_close_and_info_cont_carousel9');
let bot_log_show_cont = document.getElementById('bot_log_show_cont_carousel9');
let bot_details = document.getElementById('bot_details_carousel9');
let bot_details2 = document.getElementById('bot_details2_carousel9');
...
let martingale = document.getElementById('martingale_carousel9');
let flash_info_cont = document.getElementById('flash_info_cont_carousel9');
let tick_check_amount = document.getElementById('tick_check_amount_carousel9');
let bot_settings = document.getElementById('bot_settings_carousel9');
let settings_cont = document.getElementById('settings_cont_carousel9');
let tick_check = document.getElementById('tick_check_carousel9');
let martingale_jump = document.getElementById('martingale_jump_carousel9');
let increase_jump = document.getElementById('increase_jump_carousel9');
let reduce_jump = document.getElementById('reduce_jump_carousel9');

let bot_settings2 = document.getElementById('bot_settings2_carousel9');

const prevButton2 = document.querySelector(".prev2_carousel9");
const nextButton2 = document.querySelector(".next2_carousel9");

const volumes2 = document.querySelectorAll(".slide_vol2_carousel9");
let tick_check2 = document.getElementById('tick_check2_carousel9');
let martingale2 = document.getElementById('martingale2_carousel9');
let martingale_jump2 = document.getElementById('martingale_jump2_carousel9');
let martingale_jump_set = document.getElementById('martingale_jump_set_carousel9');

const prevButton = document.querySelector(".prev_carousel9");
const nextButton = document.querySelector(".next_carousel9");
const volumes = document.querySelectorAll(".slide_vol_carousel9");
const volumes_stream = document.querySelectorAll(".slide_vol_stream_carousel9");
const last_digit_settings = document.querySelectorAll(".last_digit_settings_carousel9");

let currentIndex = parseInt(localStorage.getItem('bot_current_vol1_carousel9')) || 0;
let currentIndex2 = parseInt(localStorage.getItem('bot_current_vol2_carousel9')) || 0;
let currentIndex3 = parseInt(localStorage.getItem('bot_current_vol3_carousel9')) || 0;

let currentIndex_cookie = parseInt(getCookie('bot_current_vol1_carousel9')) || 0;
let currentIndex2_cookie = parseInt(getCookie('bot_current_vol2_carousel9')) || 0;
let currentIndex3_cookie = parseInt(getCookie('bot_current_vol3_carousel9')) || 0;
...
prevButton.addEventListener("click", function () {
    if (currentIndex !== null && currentIndex >= 0) {
        ...
        localStorage.setItem('bot_current_vol1_carousel9', currentIndex);
        localStorage.setItem('bot_current_vol3_carousel9', currentIndex);
        setCookie('bot_current_vol1_carousel9', currentIndex);
        setCookie('bot_current_vol3_carousel9', currentIndex);
        currentIndex2 = (currentIndex2 - 1 + volumes_stream.length) % volumes_stream.length;
        localStorage.setItem('bot_current_vol2_carousel9', currentIndex2);
        setCookie('bot_current_vol2_carousel9', currentIndex2);
        volumes[currentIndex].classList.add("active");
        volumes2[currentIndex].classList.add("active");
        ...
        localStorage.setItem('bot_current_vol1_carousel9', currentIndex_cookie);
        localStorage.setItem('bot_current_vol3_carousel9', currentIndex_cookie);
        setCookie('bot_current_vol1_carousel9', currentIndex_cookie);
        setCookie('bot_current_vol3_carousel9', currentIndex_cookie);
        currentIndex2_cookie = (currentIndex2_cookie - 1 + volumes_stream.length) % volumes_stream.length;
        localStorage.setItem('bot_current_vol2_carousel9', currentIndex2_cookie);
        setCookie('bot_current_vol2_carousel9', currentIndex2_cookie);
        volumes[currentIndex_cookie].classList.add("active");
        volumes2[currentIndex_cookie].classList.add("active");
...
martingale.addEventListener('click', function () {
    ...
    if (flash_info_cont.classList.contains('show_flash_info_carousel9')) {
        flash_info_cont.classList.remove('show_flash_info_carousel9')
        ...
        flash_info_cont.classList.add('show_flash_info_carousel9')
...
function jump_count_set() {
    localStorage.setItem('bot_jump_carousel9', jump_count)
    setCookie('bot_jump_carousel9', jump_count)
}
...
prevButton2.addEventListener("click", function () {
    if (currentIndex !== null && currentIndex >= 0) {
        ...
        setCookie('bot_current_vol3_carousel9', currentIndex)
        currentIndex2 = (currentIndex2 - 1 + volumes_stream.length) % volumes_stream.length;
        localStorage.setItem('bot_current_vol2_carousel9', currentIndex)
        setCookie('bot_current_vol2_carousel9', currentIndex)
        volumes[currentIndex].classList.add("active");
        volumes2[currentIndex].classList.add("active");
        volumes_stream[currentIndex2].classList.add("active");
    } else if (currentIndex_cookie !== null && currentIndex_cookie >= 0) {
        ...
        setCookie('bot_current_vol3_carousel9', currentIndex_cookie)
        currentIndex2_cookie = (currentIndex2_cookie - 1 + volumes_stream.length) % volumes_stream.length;
        localStorage.setItem('bot_current_vol2_carousel9', currentIndex_cookie)
        setCookie('bot_current_vol2_carousel9', currentIndex_cookie)
        volumes[currentIndex_cookie].classList.add("active");
        volumes2[currentIndex_cookie].classList.add("active");
        volumes_stream[currentIndex2_cookie].classList.add("active");
    }
