...
let martingale_store_symbol_vol75_1s = [0.35, 3.5, 38.9, 432.3]
...
async function startBot_symbol_vol75_1s(martingale, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber) {
    if (first_instance_symbol_vol75_1s == true) {
        bot_id_symbol_vol75_1s = 0
    }
...
let bot_state_carousel9_symbol_vol75_1s = null
let bot_state_carousel9_cookie_symbol_vol75_1s = null
...
function togglePlayPause_symbol_vol75_1s() {
    ...
    if (play_button_carousel9) {
        ...
        if ((bot_state_carousel9 == 'stop_bot' || bot_state_carousel9_cookie == 'stop_bot') && (bots_state_carousel9 == 'stop_bots' || bots_state_carousel9_cookie == 'stop_bots')) {
            bot_is_running_or_stopped_symbol_vol75_1s = false;
...
let set_vol75_1s_trade_carousel9_symbol_vol75_1s = null
...
let set_vol75_1s_trade_carousel9_cookie_symbol_vol75_1s = null
...
let checkCount_symbol_vol75_1s = 0
...
const tickResponse_symbol_vol75_1s = async (res) => {
    ...
    if (data.msg_type === 'tick') {
        ...
        all_bot_start_stop1_symbol_vol75_1s = localStorage.getItem('bots_state_carousel9')
        all_bot_start_stop1_cookie_symbol_vol75_1s = getCookie('bots_state_carousel9')

        bot_state_carousel9_symbol_vol75_1s = localStorage.getItem('bot_state_carousel9')
        bot_state_carousel9_cookie_symbol_vol75_1s = getCookie('bot_state_carousel9')

        set_vol75_1s_trade_carousel9_symbol_vol75_1s = localStorage.getItem('set_vol75_1s_trade')
        ...
        set_vol75_1s_trade_carousel9_cookie_symbol_vol75_1s = localStorage.getItem('set_vol75_1s_trade')
        ...
        processNumber(currentRandom_symbol_vol75_1s);
        ...
        if (currentRandom_symbol_vol75_1s !== null && lastNumber1_symbol_vol75_1s !== null && lastNumber2_symbol_vol75_1s !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance_symbol_vol75_1s == true) {
                if (currentRandom_symbol_vol75_1s && (first_instance_symbol_vol75_1s == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9_symbol_vol75_1s == 1 || bot_set_carousel9_cookie_symbol_vol75_1s == 1)) {
                    if (((bot_state_carousel9_symbol_vol75_1s == 'start_bot' || bot_state_carousel9_cookie_symbol_vol75_1s == 'start_bot') && (all_bot_start_stop1_symbol_vol75_1s == 'start_bots' || all_bot_start_stop1_cookie_symbol_vol75_1s == 'start_bots')) && ((set_vol75_1s_trade_carousel9_symbol_vol75_1s == 'vol75_1s_trade') || (set_vol75_1s_trade_carousel9_cookie_symbol_vol75_1s == 'vol75_1s_trade'))) {
        ...
        if (currentRandom_symbol_vol75_1s !== null && lastNumber1_symbol_vol75_1s !== null && lastNumber2_symbol_vol75_1s !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance_symbol_vol75_1s == true) {
                if ((lastNumber2_symbol_vol75_1s == lastNumber1_symbol_vol75_1s) && (lastNumber1_symbol_vol75_1s !== currentRandom_symbol_vol75_1s) && (first_instance_symbol_vol75_1s == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9_symbol_vol75_1s == 2 || bot_set_carousel9_cookie_symbol_vol75_1s == 2)) {
                   if (((bot_state_carousel9_symbol_vol75_1s == 'start_bot' || bot_state_carousel9_cookie_symbol_vol75_1s == 'start_bot') && (all_bot_start_stop1_symbol_vol75_1s == 'start_bots' || all_bot_start_stop1_cookie_symbol_vol75_1s == 'start_bots')) && ((set_vol75_1s_trade_carousel9_symbol_vol75_1s == 'vol75_1s_trade') || (set_vol75_1s_trade_carousel9_cookie_symbol_vol75_1s == 'vol75_1s_trade'))) {
                        startBot_symbol_vol75_1s(martingale_active_carousel9_cookie_symbol_vol75_1s, lastNumber10_symbol_vol75_1s, lastNumber9_symbol_vol75_1s, lastNumber8_symbol_vol75_1s, lastNumber7_symbol_vol75_1s, lastNumber6_symbol_vol75_1s, lastNumber5_symbol_vol75_1s, lastNumber4_symbol_vol75_1s, lastNumber3_symbol_vol75_1s, lastNumber2_symbol_vol75_1s, lastNumber1_symbol_vol75_1s, currentRandom_symbol_vol75_1s, strNumber_symbol_vol75_1s)
                    } else  {
        ...
        if (currentRandom_symbol_vol75_1s !== null && lastNumber1_symbol_vol75_1s !== null && lastNumber2_symbol_vol75_1s !== null) {
            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) || first_instance_symbol_vol75_1s == true) {
                if ((resultValue !== null) && (first_instance_symbol_vol75_1s == true || (tag5_carousel9.textContent.trim() !== '' && tag6_carousel9.textContent.trim() !== '' && tag8_carousel9.textContent.trim() !== '' && tag9_carousel9.textContent.trim() !== '')) && (bot_set_carousel9_symbol_vol75_1s == 3 || bot_set_carousel9_cookie_symbol_vol75_1s == 3)) {
                    if (((bot_state_carousel9_symbol_vol75_1s == 'start_bot' || bot_state_carousel9_cookie_symbol_vol75_1s == 'start_bot') && (all_bot_start_stop1_symbol_vol75_1s == 'start_bots' || all_bot_start_stop1_cookie_symbol_vol75_1s == 'start_bots')) && ((set_vol75_1s_trade_carousel9_symbol_vol75_1s == 'vol75_1s_trade') || (set_vol75_1s_trade_carousel9_cookie_symbol_vol75_1s == 'vol75_1s_trade'))) {
                        startBot_symbol_vol75_1s(martingale_active_carousel9_cookie_symbol_vol75_1s, lastNumber10_symbol_vol75_1s, lastNumber9_symbol_vol75_1s, lastNumber8_symbol_vol75_1s, lastNumber7_symbol_vol75_1s, lastNumber6_symbol_vol75_1s, lastNumber5_symbol_vol75_1s, lastNumber4_symbol_vol75_1s, lastNumber3_symbol_vol75_1s, lastNumber2_symbol_vol75_1s, lastNumber1_symbol_vol75_1s, currentRandom_symbol_vol75_1s, strNumber_symbol_vol75_1s)
                        resultValue = null
                    } else {
        ...
        if (tag5_carousel9 && tag5_carousel9 && tag8_carousel9 && tag9_carousel9) {
            if (tag5_carousel9.textContent.trim() === '' && tag6_carousel9.textContent.trim() === '' && tag8_carousel9.textContent.trim() === '' && tag9_carousel9.textContent.trim() === '') {
                console.log('Tags are empty:', tag5_carousel9.textContent, tag5_carousel9.textContent, tag8_carousel9.textContent, tag9_carousel9.textContent);
                checkCount_symbol_vol75_1s += 1;
                console.log('checkCount', checkCount_symbol_vol75_1s);
        
                if (checkCount_symbol_vol75_1s == 500) {
                    console.log('hanged');
                    initializeApi(message1);
                }
            }
        ...
        //             } 
        //         }else if (tag5_carousel9.textContent.trim() == '' && tag6_carousel9.textContent.trim() == '' && tag8_carousel9.textContent.trim() == '' && tag9_carousel9.textContent.trim() == '') {
        //             checkCount_symbol_vol75_1s += 1
        //            if ((tag5_carousel9.textContent.trim() == '' && tag6_carousel9.textContent.trim() == '' && tag8_carousel9.textContent.trim() == '' && tag9_carousel9.textContent.trim() == '') && checkCount_symbol_vol75_1s == 500){
        //             console.log('hanged')
        //             initializeApi(message1)
        //            }
        //         }
        ...
        //             } 
        //         }else if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) && (tag5_carousel9.textContent.trim() == '' && tag6_carousel9.textContent.trim() == '' && tag8_carousel9.textContent.trim() == '' && tag9_carousel9.textContent.trim() == '')) {
        //             checkCount_symbol_vol75_1s += 1
        //            if ((tag5_carousel9 && tag6_carousel9 && tag8_carousel9 && tag9_carousel9) && (tag5_carousel9.textContent.trim() == '' && tag6_carousel9.textContent.trim() == '' && tag8_carousel9.textContent.trim() == '' && tag9_carousel9.textContent.trim() == '') && checkCount_symbol_vol75_1s == 500){
        //             console.log('hanged')
        //             initializeApi(message1)
        //            }
        //         }
...
window.addEventListener('load', function () {
    ...
    if (last_digit_prediction_cookie_symbol_vol75_1s) {
        last_digit_prediction_or_barrier_symbol_vol75_1s = last_digit_prediction_cookie_symbol_vol75_1s
    } else {
...
function before_trade_symbol_vol75_1s() {
    ...
    durr_amount_prop_symbol_vol75_1s.textContent = duration_amount_symbol_vol75_1s
        ...
        if (allProposalOpenContract2_symbol_vol75_1s.length > 0 && allProposalOpenContract2_symbol_vol75_1s[allProposalOpenContract2_symbol_vol75_1s.length - 1].length > 0) {
            ...
            if (data.proposal_open_contract.status !== 'open') {
                ...
                if (profit_or_loss2_symbol_vol75_1s < 0) {
                    ...
                    checkCount_symbol_vol75_1s += 1
                   if ((tag5.textContent.trim() == '' && tag6.textContent.trim() == '' && tag8.textContent.trim() == '' && tag9.textContent.trim() == '') && checkCount_symbol_vol75_1s == 500){
                    console.log('hanged')
                    initializeApi(message1)
                   }
                }
