...
async function add_after_trade_symbol_vol25_1s(bot_id, botuniqueCode, allContracts, entry_spot, exit_spot, profit_loss, status, bot_total_runs, bot_total_stake, bot_total_payout, bot_total_wins, bot_total_loss, bot_total_profit_loss) {
    ...
    if (botuniqueCode == allContracts) {
        ...
        if (parseFloat(Number(bot_total_profit_loss_symbol_vol25_1s.toFixed(2))) < 0) {
...
let martingale_store_symbol_vol25_1s = [0.35, 3.5, 38.9, 432.3]
...
async function startBot_symbol_vol25_1s(martingale, lastNumber10, lastNumber9, lastNumber8, lastNumber7, lastNumber6, lastNumber5, lastNumber4, lastNumber3, lastNumber2, lastNumber1, currentRandom, strNumber) {
    if (first_instance_symbol_vol25_1s == true) {
        bot_id_symbol_vol25_1s = 0
    }
...
let bot_state_carousel7_symbol_vol25_1s = null
let bot_state_carousel7_cookie_symbol_vol25_1s = null
...
function togglePlayPause_symbol_vol25_1s() {
    ...
    if (play_button_carousel7) {
        ...
        if ((bot_state_carousel7 == 'stop_bot' || bot_state_carousel7_cookie == 'stop_bot') && (bots_state_carousel7 == 'stop_bots' || bots_state_carousel7_cookie == 'stop_bots')) {
            bot_is_running_or_stopped_symbol_vol25_1s = false;
...
let set_vol25_1s_trade_carousel7_symbol_vol25_1s = null
...
let set_vol25_1s_trade_carousel7_cookie_symbol_vol25_1s = null
...
let checkCount_symbol_vol25_1s = 0
...
const tickResponse_symbol_vol25_1s = async (res) => {
    ...
    if (data.msg_type === 'tick') {
        ...
        all_bot_start_stop1_symbol_vol25_1s = localStorage.getItem('bots_state_carousel7')
        all_bot_start_stop1_cookie_symbol_vol25_1s = getCookie('bots_state_carousel7')

        bot_state_carousel7_symbol_vol25_1s = localStorage.getItem('bot_state_carousel7')
        bot_state_carousel7_cookie_symbol_vol25_1s = getCookie('bot_state_carousel7')

        set_vol25_1s_trade_carousel7_symbol_vol25_1s = localStorage.getItem('set_vol25_1s_trade')
        ...
        set_vol25_1s_trade_carousel7_cookie_symbol_vol25_1s = localStorage.getItem('set_vol25_1s_trade')
        ...
        processNumber(currentRandom_symbol_vol25_1s);
        ...
        if (currentRandom_symbol_vol25_1s !== null && lastNumber1_symbol_vol25_1s !== null && lastNumber2_symbol_vol25_1s !== null) {
            if ((tag5_carousel7 && tag6_carousel7 && tag8_carousel7 && tag9_carousel7) || first_instance_symbol_vol25_1s == true) {
                if (currentRandom_symbol_vol25_1s && (first_instance_symbol_vol25_1s == true || (tag5_carousel7.textContent.trim() !== '' && tag6_carousel7.textContent.trim() !== '' && tag8_carousel7.textContent.trim() !== '' && tag9_carousel7.textContent.trim() !== '')) && (bot_set_carousel7_symbol_vol25_1s == 1 || bot_set_carousel7_cookie_symbol_vol25_1s == 1)) {
                    if (((bot_state_carousel7_symbol_vol25_1s == 'start_bot' || bot_state_carousel7_cookie_symbol_vol25_1s == 'start_bot') && (all_bot_start_stop1_symbol_vol25_1s == 'start_bots' || all_bot_start_stop1_cookie_symbol_vol25_1s == 'start_bots')) && ((set_vol25_1s_trade_carousel7_symbol_vol25_1s == 'vol25_1s_trade') || (set_vol25_1s_trade_carousel7_cookie_symbol_vol25_1s == 'vol25_1s_trade'))) {
        ...
        if (currentRandom_symbol_vol25_1s !== null && lastNumber1_symbol_vol25_1s !== null && lastNumber2_symbol_vol25_1s !== null) {
            if ((tag5_carousel7 && tag6_carousel7 && tag8_carousel7 && tag9_carousel7) || first_instance_symbol_vol25_1s == true) {
                if ((resultValue !== null) && (first_instance_symbol_vol25_1s == true || (tag5_carousel7.textContent.trim() !== '' && tag6_carousel7.textContent.trim() !== '' && tag8_carousel7.textContent.trim() !== '' && tag9_carousel7.textContent.trim() !== '')) && (bot_set_carousel7_symbol_vol25_1s == 3 || bot_set_carousel7_cookie_symbol_vol25_1s == 3)) {
                    if (((bot_state_carousel7_symbol_vol25_1s == 'start_bot' || bot_state_carousel7_cookie_symbol_vol25_1s == 'start_bot') && (all_bot_start_stop1_symbol_vol25_1s == 'start_bots' || all_bot_start_stop1_cookie_symbol_vol25_1s == 'start_bots')) && ((set_vol25_1s_trade_carousel7_symbol_vol25_1s == 'vol25_1s_trade') || (set_vol25_1s_trade_carousel7_cookie_symbol_vol25_1s == 'vol25_1s_trade'))) {
                        startBot_symbol_vol25_1s(martingale_active_carousel7_cookie_symbol_vol25_1s, lastNumber10_symbol_vol25_1s, lastNumber9_symbol_vol25_1s, lastNumber8_symbol_vol25_1s, lastNumber7_symbol_vol25_1s, lastNumber6_symbol_vol25_1s, lastNumber5_symbol_vol25_1s, lastNumber4_symbol_vol25_1s, lastNumber3_symbol_vol25_1s, lastNumber2_symbol_vol25_1s, lastNumber1_symbol_vol25_1s, currentRandom_symbol_vol25_1s, strNumber_symbol_vol25_1s)
                        resultValue = null
                    } else {
        ...
        if (tag5_carousel7 && tag5_carousel7 && tag8_carousel7 && tag9_carousel7) {
            if (tag5_carousel7.textContent.trim() === '' && tag6_carousel7.textContent.trim() === '' && tag8_carousel7.textContent.trim() === '' && tag9_carousel7.textContent.trim() === '') {
                console.log('Tags are empty:', tag5_carousel7.textContent, tag5_carousel7.textContent, tag8_carousel7.textContent, tag9_carousel7.textContent);
                checkCount_symbol_vol25_1s += 1;
                console.log('checkCount', checkCount_symbol_vol25_1s);

                if (checkCount_symbol_vol25_1s == 500) {
                    console.log('hanged');
                    initializeApi(message1);
                }
            }
        ...
        //             } 
        //         }else if (tag5_carousel7.textContent.trim() == '' && tag6_carousel7.textContent.trim() == '' && tag8_carousel7.textContent.trim() == '' && tag9_carousel7.textContent.trim() == '') {
        //             checkCount_symbol_vol25_1s += 1
        //            if ((tag5_carousel7.textContent.trim() == '' && tag6_carousel7.textContent.trim() == '' && tag8_carousel7.textContent.trim() == '' && tag9_carousel7.textContent.trim() == '') && checkCount_symbol_vol25_1s == 500){
        //             console.log('hanged')
        //             initializeApi(message1)
        //            }
        //         }
...
window.addEventListener('load', function () {
    ...
    if (last_digit_prediction_cookie_symbol_vol25_1s) {
        last_digit_prediction_or_barrier_symbol_vol25_1s = last_digit_prediction_cookie_symbol_vol25_1s
    } else {
...
function before_trade_symbol_vol25_1s() {
    ...
    durr_amount_prop_symbol_vol25_1s.textContent = duration_amount_symbol_vol25_1s
        ...
        if (allProposalOpenContract2_symbol_vol25_1s.length > 0 && allProposalOpenContract2_symbol_vol25_1s[allProposalOpenContract2_symbol_vol25_1s.length - 1].length > 0) {
            ...
            if (data.proposal_open_contract.status !== 'open') {
                ...
                if (profit_or_loss2_symbol_vol25_1s < 0) {
                    ...
                    checkCount_symbol_vol25_1s += 1
                    if ((tag5.textContent.trim() == '' && tag6.textContent.trim() == '' && tag8.textContent.trim() == '' && tag9.textContent.trim() == '') && checkCount_symbol_vol25_1s == 500) {
                        console.log('hanged')
                        initializeApi(message1)
                    }
                }
