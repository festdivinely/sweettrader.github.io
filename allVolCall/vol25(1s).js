...
const tickResponse = async (res) => {
    ...
    if (data.msg_type === 'tick') {
        ...
        if((set_bot_jump_carousel7 && set_bot_jump_carousel7 > 0) && contract_status2 == 'lost'){
            bot_set_carousel7 = parseInt(bot_set_carousel7) + parseInt(set_bot_jump_carousel7)
            contract_status2 == 'reset'
        }else if(initial_set_jump == true || (contract_status2 == 'won' && (set_bot_jump_carousel7 && set_bot_jump_carousel7 > 0))){
            bot_set_carousel7 = localStorage.getItem('bot_set_carousel7');
...
function jump_count_set2() {
    let stored_jump_count = localStorage.getItem('bot_jump_carousel7');
