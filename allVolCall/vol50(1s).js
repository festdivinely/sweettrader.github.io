...
const tickResponse = async (res) => {
    ...
    if (data.msg_type === 'tick') {
        ...
        if((set_bot_jump_carousel8 && set_bot_jump_carousel8 > 0) && contract_status2 == 'lost'){
            bot_set_carousel8 = parseInt(bot_set_carousel8) + parseInt(set_bot_jump_carousel8)
            contract_status2 == 'reset'
        }else if(initial_set_jump == true || (contract_status2 == 'won' && (set_bot_jump_carousel8 && set_bot_jump_carousel8 > 0))){
            bot_set_carousel8 = localStorage.getItem('bot_set_carousel8');
...
function jump_count_set2() {
    let stored_jump_count = localStorage.getItem('bot_jump_carousel8');
